...
#| Sprixel.BlockDelegate object.  If not defined, the codegen method will be
#| called.
has #`( Sprixel::BlockDelegate ) $.clr-delegate;
...
method codegen() {
    ...
    my $starter = System::Reflection::DynamicMethod.new("__ANON__",
        System::Void, [ Sprixel::FrameBase, Sprixel::FrameBase ],
        Block);
